 ...
 * @since 1.0.0
 */
class WPZOOM_Select_Slider_Post extends Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field-description">
			...
			<a href="<?php echo admin_url( 'post.php?post={{{ value }}}&action=edit' ) ?>" target="_blank"><?php echo esc_html__( 'Edit Slide', 'wpzoom-elementor-addons' ) ?></a> Settings
		</div>
		<?php
	}
}
