 ...
 */
class WPZOOM_Source extends Source_Base {

	/**
	 * New library option key.
	 */
	const LIBRARY_OPTION_KEY = 'wpzoom_remote_info_library';

	/**
	 * Timestamp cache key to trigger library sync.
	 */
	const TIMESTAMP_CACHE_KEY = 'wpzoom_remote_update_timestamp';
	...
	public function get_title() {
		return esc_html__( 'Remote', 'custom-elementor-source' );
	}
